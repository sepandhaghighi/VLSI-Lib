...
// Cell name: Xor2
// View name: schematic
M1 (Out Bp A A) nmos_rf lr=100n wr=1.2u nr=8 m=1 mismatchflag=0
M0 (Out B Ap Ap) nmos_rf lr=100n wr=1.2u nr=8 m=1 mismatchflag=0
